            ...
            <div className="flex items-center justify-between flex-wrap gap-2">
              ...
              {activeCategoryFilter !== 'all' && (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 text-xs font-bold text-flo-600 hover:text-flo-700 hover:underline cursor-pointer"
                >
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 p-4 sm:p-5 flex flex-col justify-between w-full space-y-2.5 min-w-0">
        <div>
          <h4 className="text-sm sm:text-base font-bold text-gray-900 group-hover:text-flo-600 transition-colors leading-snug line-clamp-2">
            {article.title}
          </h4>
          <p className="text-xs text-gray-500 line-clamp-2 mt-1.5 font-normal leading-relaxed">
            {article.summary}
          </p>
        </div>
