...
export function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://trackperiods.com/about/${pageData.slug}`,
    },
    openGraph: {
      title: safeTitle,
      description: safeDesc,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="space-y-6 text-gray-800 leading-relaxed">
            {pageData.content && pageData.content.map((sec, idx) => (
              <div key={idx} className="bg-white rounded-3xl border border-pink-100/90 p-6 sm:p-8 shadow-xs space-y-4">
                <h3 className=" font-extrabold flex items-center gap-3">
                ...
                {sec.bullets && sec.bullets.length > 0 && (
                  <div className="mt-3 pl-9">
                    <div className={`${accentClasses.bulletCard} border rounded-2xl p-4 sm:p-5 space-y-2.5`}>
                      <h4 className={`text-sm font-black uppercase tracking-wider ${accentClasses.bulletTitle}`}>
        ...
        <aside className="lg:col-span-4 space-y-6 lg:sticky lg:top-28">
            ...
            <div className="space-y-1.5">
              {otherPages && otherPages.map((p) => (
                <Link
                  key={p.slug}
                  href={`/about/${p.slug}`}
                  className="text-sm flex items-center justify-between p-2.5 rounded-2xl hover:bg-pink-50/70 text-base font-bold text-gray-700 hover:text-flo-600 transition-colors"
                >
          ...
          <div className="bg-gradient-to-br from-pink-500 to-rose-500 rounded-3xl p-6 text-white space-y-3 shadow-md shadow-pink-200">
            <div className="text-sm font-bold uppercase tracking-wider text-pink-100">
              Free Web Tools
            </div>
            <h4 className="leading-snug text-sm text-white ">
            ...
            <Link
              href="/cycle-tools"
              className="text-sm inline-block w-full py-2.5 px-4 rounded-full bg-white text-gray-900 font-bold text-center text-base hover:bg-gray-50 transition-colors shadow-xs"
            >
    ...
    <div>
      ...
      <section className="bg-gradient-to-b from-[#fef0e7] via-[#fff6f0] to-[#fffbf9] pt-10 sm:pt-14 pb-16 border-b border-orange-100/60 overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex items-center space-x-2 text-base font-semibold text-gray-500 uppercase tracking-wider mb-8 flex-wrap">
            <Link href="/" className="text-sm hover:text-flo-600 transition-colors">Home</Link>
            <ChevronRight className="w-3.5 h-3.5 text-gray-400" />
            {/* <span className="text-gray-500">ABOUT</span>
            <ChevronRight className="w-3.5 h-3.5 text-gray-400" /> */}
            <span className="text-sm text-gray-800 font-bold">Science & Research</span>
          </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            <div className="lg:col-span-7 space-y-5">
              ...
              <div className="pt-2 flex flex-wrap items-center gap-3.5">
                ...
                >
                  ...
                  <div className="text-left">
                    {/* <div className="text-base uppercase font-medium leading-none text-gray-300">Download on the</div> */}
              ...
              <div className="pt-2 text-teal-800 text-base font-semibold flex items-center gap-1.5">
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="relative w-full max-w-sm sm:max-w-md">
                ...
                <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white bg-white">
                  ...
                  <div className="p-4 bg-white/95 backdrop-blur-md flex items-center justify-between border-t border-orange-100">
                    <div className="flex items-center gap-2.5">
                      <div className="w-8 h-8 rounded-full bg-flo-50 text-flo-600 flex items-center justify-center font-bold text-base">
                        🌸
                      </div>
                      <div>
                        <div className="text-base font-black text-gray-900">Daily Cycle Insight</div>
                        <div className="text-base text-gray-500">Day 14 • High Fertility Window</div>
                      </div>
                    </div>
                    <span className="text-base font-bold text-teal-800 bg-teal-50 px-2.5 py-1 rounded-full border border-teal-200">
                      Predictive AI
                    </span>
                  </div>
                </div>
                ...
                {/* <div className="absolute -bottom-3 -left-3 bg-white px-3.5 py-1.5 rounded-full shadow-lg border border-pink-100 text-base font-bold text-gray-800 flex items-center gap-1.5 z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="flex flex-col items-center text-center group">
              <div className="relative mb-4">
                ...
                <div className="absolute -bottom-2 inset-x-0 mx-auto w-max px-2.5 py-1 rounded-full bg-rose-600 text-white text-base font-bold shadow-sm flex items-center gap-1">
            ...
            <div className="flex flex-col items-center text-center group">
              <div className="relative mb-4">
                ...
                <div className="absolute -bottom-2 inset-x-0 mx-auto w-max px-2.5 py-1 rounded-full bg-emerald-600 text-white text-base font-bold shadow-sm flex items-center gap-1">
            ...
            <div className="flex flex-col items-center text-center group">
              <div className="relative mb-4">
                ...
                <div className="absolute -bottom-2 inset-x-0 mx-auto w-max px-2.5 py-1 rounded-full bg-amber-600 text-white text-base font-bold shadow-sm flex items-center gap-1">
            ...
            <div className="flex flex-col items-center text-center group">
              <div className="relative mb-4">
                ...
                <div className="absolute -bottom-2 inset-x-0 mx-auto w-max px-2.5 py-1 rounded-full bg-purple-600 text-white text-base font-bold shadow-sm flex items-center gap-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            <div className="lg:col-span-5 flex justify-center items-center">
              <div className="relative flex items-center justify-center">
                ...
                <div className="absolute -bottom-2 right-2 sm:right-6 bg-white/95 backdrop-blur-md px-3.5 py-1.5 rounded-full shadow-md border border-orange-200 text-base font-bold text-gray-800 flex items-center gap-1.5 z-20">
    ...
    <div className="space-y-12">
      ...
      <section className="bg-gradient-to-b from-purple-100/70 via-pink-50/40 to-[#fffbf9] pt-10 sm:pt-14 pb-14 border-b border-purple-200/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex items-center space-x-2 text-base font-semibold text-gray-500 uppercase tracking-wider mb-6 flex-wrap">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-4">
              {/* <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-100 text-purple-700 border border-purple-200 text-base font-bold">
              ...
              <div className="pt-2 flex flex-wrap gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-5 py-3 rounded-2xl bg-black text-white font-bold text-base hover:bg-gray-800 transition-colors inline-flex items-center gap-2"
                >
              ...
              <div className="w-full max-w-md bg-white rounded-3xl p-6 border border-purple-200 shadow-xl shadow-purple-900/10 space-y-4">
                <div className="flex items-center justify-between border-b border-purple-100 pb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <span className="text-base font-bold text-gray-900 block">AI Cycle Report</span>
                      <span className="text-base text-gray-400 block">Generated via On-Device AI</span>
                    </div>
                  </div>
                  <span className="text-base font-bold text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded-full border border-emerald-200">
                    Active Cycle
                  </span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2.5 text-base">
                  <div className="p-3 bg-purple-50/50 rounded-2xl border border-purple-100">
                    <span className="text-base text-gray-400 font-bold block uppercase">Predicted Length</span>
                  ...
                  <div className="p-3 bg-pink-50/50 rounded-2xl border border-pink-100">
                    <span className="text-base text-gray-400 font-bold block uppercase">Ovulation Surge</span>
                    <span className="text-lg font-black text-flo-600 mt-0.5 block">Day 14 (Peak)</span>
                  </div>
                </div>

                <div className="p-3.5 bg-gray-50 rounded-2xl border border-gray-100 text-base text-gray-600 space-y-1.5">
                  <strong className="text-gray-900 block text-base">AI Pattern Insight:</strong>
      ...
      <section className="bg-gradient-to-b from-emerald-100/60 via-teal-50/30 to-[#fffbf9] pt-10 sm:pt-14 pb-14 border-b border-emerald-200/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7 space-y-4">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-100 text-emerald-800 border border-emerald-200 text-base font-bold">
              ...
              <div className="pt-2 flex flex-wrap items-center gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-5 py-2.5 rounded-2xl bg-black text-white font-bold text-base hover:bg-gray-800 transition-colors"
                >
                  Download on iOS
                </a>
                <a
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="relative">
                ...
                <div className="absolute -bottom-3 inset-x-0 mx-auto w-max px-4 py-1.5 rounded-full bg-emerald-700 text-white text-base font-bold shadow-md flex items-center gap-1.5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {remedies.map((rem, idx) => (
            <div key={idx} className="bg-white rounded-3xl p-6 sm:p-7 border border-emerald-100 shadow-xs hover:shadow-md transition-shadow space-y-3">
              ...
              <h3 className="text-sm">{rem.title}</h3>
              <p className=" text-gray-600 text-sm">{rem.benefit}</p>
              
              <div className="pt-2 border-t border-emerald-50 text-base text-gray-400 font-medium !text-sm">
    ...
    <div className="space-y-12">
      ...
      <section className="bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 text-white pt-10 sm:pt-14 pb-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex items-center space-x-2 text-base font-semibold text-gray-400 uppercase tracking-wider mb-6 flex-wrap">
          ...
          <div className="max-w-3xl space-y-4">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 text-base font-bold">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-14 sm:my-20">
        <div className="bg-white rounded-3xl p-6 sm:p-10 lg:p-12 border border-slate-100 shadow-xl grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-5 text-left">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-teal-50 border border-teal-200 text-teal-800 text-base font-bold">
            ...
            <div className="p-4 rounded-2xl bg-teal-50/60 border border-teal-100 text-base text-teal-900 leading-relaxed italic">
    ...
    <div className="space-y-12">
            ...
            <div className="bg-white rounded-3xl p-6 border border-pink-100 shadow-xs space-y-3">
              ...
              <div className="flex gap-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 py-2.5 px-3 rounded-xl bg-black text-white text-base font-bold text-center hover:bg-gray-800 transition-colors"
                >
                  iOS App Store
                </a>
                <a
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-14 sm:my-20">
        <div className="bg-white rounded-3xl p-6 sm:p-10 lg:p-12 border border-rose-100 shadow-xl grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-5 text-left">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-rose-50 border border-rose-200 text-rose-800 text-base font-bold">
            ...
            <div className="p-4 rounded-2xl bg-rose-50/60 border border-rose-100 text-base text-rose-900 leading-relaxed italic">
