      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                ...
                {sec.bullets && sec.bullets.length > 0 && (
                  <div className="mt-3 pl-9">
                    <div className={`${accentClasses.bulletCard} border rounded-2xl p-4 sm:p-5 space-y-2.5`}>
                      <h4 className={`text-base font-black uppercase tracking-wider ${accentClasses.bulletTitle}`}>
        ...
        <aside className="lg:col-span-4 space-y-6 lg:sticky lg:top-28">
            ...
            <div className="space-y-1.5">
              {otherPages && otherPages.map((p) => (
                <Link
                  key={p.slug}
                  href={`/about/${p.slug}`}
                  className="flex items-center justify-between p-2.5 rounded-2xl hover:bg-pink-50/70 text-base font-bold text-gray-700 hover:text-flo-600 transition-colors"
                >
          ...
          <div className="bg-gradient-to-br from-pink-500 to-rose-500 rounded-3xl p-6 text-white space-y-3 shadow-md shadow-pink-200">
            ...
            <Link
              href="/cycle-tools"
              className="inline-block w-full py-2.5 px-4 rounded-full bg-white text-gray-900 font-bold text-center text-base hover:bg-gray-50 transition-colors shadow-xs"
            >
