                  ...
                  <div className="p-4 bg-white/95 backdrop-blur-md flex items-center justify-between border-t border-orange-100">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-gray-500">Day 14 • High Fertility Window</div>
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="flex flex-col items-center text-center group">
              <div className="relative mb-4">
                ...
                <div className="absolute -bottom-2 inset-x-0 mx-auto w-max px-2.5 py-1 rounded-full bg-rose-600 text-white text-xs font-bold shadow-sm flex items-center gap-1">
            ...
            <div className="flex flex-col items-center text-center group">
              <div className="relative mb-4">
                ...
                <div className="absolute -bottom-2 inset-x-0 mx-auto w-max px-2.5 py-1 rounded-full bg-emerald-600 text-white text-xs font-bold shadow-sm flex items-center gap-1">
            ...
            <div className="flex flex-col items-center text-center group">
              <div className="relative mb-4">
                ...
                <div className="absolute -bottom-2 inset-x-0 mx-auto w-max px-2.5 py-1 rounded-full bg-amber-600 text-white text-xs font-bold shadow-sm flex items-center gap-1">
            ...
            <div className="flex flex-col items-center text-center group">
              <div className="relative mb-4">
                ...
                <div className="absolute -bottom-2 inset-x-0 mx-auto w-max px-2.5 py-1 rounded-full bg-purple-600 text-white text-xs font-bold shadow-sm flex items-center gap-1">
              ...
              <div className="w-full max-w-md bg-white rounded-3xl p-6 border border-purple-200 shadow-xl shadow-purple-900/10 space-y-4">
                <div className="flex items-center justify-between border-b border-purple-100 pb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <span className="text-xs text-gray-400 block">Generated via On-Device AI</span>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-2.5 text-xs">
                  <div className="p-3 bg-purple-50/50 rounded-2xl border border-purple-100">
                    <span className="text-xs text-gray-400 font-bold block uppercase">Predicted Length</span>
                  ...
                  <div className="p-3 bg-pink-50/50 rounded-2xl border border-pink-100">
                    <span className="text-xs text-gray-400 font-bold block uppercase">Ovulation Surge</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {remedies.map((rem, idx) => (
            <div key={idx} className="bg-white rounded-3xl p-6 sm:p-7 border border-emerald-100 shadow-xs hover:shadow-md transition-shadow space-y-3">
              ...
              <div className="pt-2 border-t border-emerald-50 text-xs text-gray-400 font-medium">
