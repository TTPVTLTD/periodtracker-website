              ...
              <div className="mb-10 bg-amber-50 border-l-4 border-amber-500 rounded-r-2xl p-6 flex flex-col sm:flex-row items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-800 leading-relaxed font-medium">
                    TrackFlow is a cycle-tracking tool designed for educational and self-care purposes. <strong>TrackFlow does not provide medical diagnostics, medical advice, or family planning/contraception services.</strong> Predictive windows should not be relied upon to prevent pregnancy. Always consult a certified medical provider for health advice.
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-12">
                  ...
                  <div className="space-y-10 text-gray-600">
                    <section id="acceptance" className="scroll-mt-24 space-y-4">
                      ...
                      <p className="leading-relaxed">By downloading, installing, accessing, or using the TrackFlow mobile application or landing page website, you agree to be bound by these Terms & Conditions. If you do not agree with any part of these terms, you must not access or use our services.</p>
                    </section>
                    ...
                    <section id="medical-disclaimer" className="scroll-mt-24 space-y-4">
                      ...
                      <p className="leading-relaxed">TrackFlow is a cycle-tracking tool designed for educational, self-care, and general wellness purposes. <strong>TrackFlow does not provide medical diagnostics, medical advice, or family planning/contraception services.</strong></p>
                    ...
                    <section id="billing" className="scroll-mt-24 space-y-4">
                      ...
                      <p className="leading-relaxed">TrackFlow offers access to premium features (including detailed wellness analysis, phase nutritional advice, and PDF reports) through paid subscriptions.</p>
                    ...
                    <section id="liability" className="scroll-mt-24 space-y-4">
                      ...
                      <p className="leading-relaxed">To the maximum extent permitted by law, TrackFlow and its developers shall not be liable for any medical issues, family planning outcomes, diagnostic errors, or data loss arising from the use of, or inability to use, the tracking services.</p>
                    </section>
