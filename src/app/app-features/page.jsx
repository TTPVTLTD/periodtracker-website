      ...
      <main className="flex-1">
        ...
        <section id="app-features-hero" className="scroll-mt-24 pt-12 sm:pt-16 pb-14 sm:pb-16 bg-mesh-glow border-b border-pink-100/80 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/95 border border-pink-200 text-brand-pink text-xs font-bold shadow-2xs">
            ...
            <div className="pt-2 flex flex-wrap items-center justify-center gap-3">
              <a
                ...
                className="inline-flex items-center gap-2.5 px-5 py-2.5 bg-black hover:bg-gray-900 text-white rounded-2xl font-bold text-xs shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5 cursor-pointer"
              >
            ...
            <div className="pt-6 grid grid-cols-2 md:grid-cols-4 gap-3 max-w-3xl mx-auto">
              <div className="bg-white/90 backdrop-blur-sm p-3.5 rounded-2xl border border-pink-100 shadow-2xs">
                ...
                <div className="text-xs text-brand-gray font-medium">Cycle Accuracy</div>
              </div>
              <div className="bg-white/90 backdrop-blur-sm p-3.5 rounded-2xl border border-pink-100 shadow-2xs">
                <div className="text-xl font-black text-emerald-700">100%</div>
                <div className="text-xs text-brand-gray font-medium">Encrypted Privacy</div>
              </div>
              <div className="bg-white/90 backdrop-blur-sm p-3.5 rounded-2xl border border-pink-100 shadow-2xs">
                <div className="text-xl font-black text-brand-peach">50+</div>
                <div className="text-xs text-brand-gray font-medium">Ayurvedic Remedies</div>
              </div>
              <div className="bg-white/90 backdrop-blur-sm p-3.5 rounded-2xl border border-pink-100 shadow-2xs">
                <div className="text-xl font-black text-purple-700">Real-Time</div>
                <div className="text-xs text-brand-gray font-medium">Encrypted Sync</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-[#FAF8F9] border-b border-pink-100">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-2xl mx-auto mb-10 space-y-2">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-brand-accent border border-pink-200 text-brand-pink text-xs font-bold">
            ...
            <div className="space-y-3">
              {APP_FEATURES_FAQS.map((faq, fIdx) => (
                ...
                >
                  ...
                  {activeFaq === fIdx && (
                    <div className="px-5 pb-5 pt-1 text-xs sm:text-sm text-brand-gray leading-relaxed border-t border-pink-100 bg-brand-accent/20">
                      {faq.answer}
                    </div>
                  )}
                </div>
